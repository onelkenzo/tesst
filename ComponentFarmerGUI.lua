--[[
    Component Farmer with GUI
    Continuously dupes and dismantles items for components until toggled off.
]]
...
ScreenGui.Name = "ComponentFarmerGUI"
...
local function farmComponents()
    ...
    if not droppedItems then
        StatusLabel.Text = "⚠️ No items found!"
        return 0
    end
    ...
    if closestItem then
        ...
        -- Dismantle all duped items
        StatusLabel.Text = "🔨 Dismantling..."
        task.wait(0.5)
        ...
        StatusLabel.Text = "✅ Dismantled " .. dismantled .. " items!"
...
print("🔧 Component Farmer GUI loaded!")
