...
UILib:CreateToggle(MiscPanel, {
    ...
    Callback = function(state)
        ...
        if state then
            ...
            -- Auto Shift-Lock + No Shake when Cyberpsycho is active
            task.spawn(function()
                while getgenv().DisableCyberpsychoVFX do
                    ...
                    if char and char:FindFirstChild("Values") then
                        ...
                        if cyberValue and cyberValue.Value > 0 then
                            -- Cyberpsycho is active - enable NoCameraEffects + shift-lock
                            ...
                            if not getgenv().CyberpsychoShiftLock then
                                ...
                                UILib:CreateNotification({Text = "Cyberpsycho Mode ON 🔒\nNo Shake + Shift-Lock!", Duration = 2})
                            end
                        else
                            -- Cyberpsycho is not active - disable everything
